        ...
        <div className="p-4 border-t border-slate-200 space-y-2">
          ...
          {isAdmin && (
            <Link
              ...
              className="flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm text-primary font-medium hover:bg-primary/10 transition-colors"
            >
              <svg
                className="w-4 h-4"
                fill="none"
